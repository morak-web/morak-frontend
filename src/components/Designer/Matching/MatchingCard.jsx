...
export default function MatchingCard(props) {
  ...
  return (
    <div className="bg-gradient-to-br from-white to-neutral-50 border-2 border-neutral-200 w-full rounded-2xl overflow-hidden hover:shadow-xl transition-all hover:scale-[1.01] hover:border-blue-300">
      <div className="flex">
        {/* left content */}
        <div className="flex-1 px-8 py-6">
          <div className="flex items-start justify-between mb-4">
            <h1 className="text-neutral-900 text-xl font-bold leading-tight flex-1">{props.title}</h1>
            <span className="ml-4 px-4 py-1.5 rounded-full text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#F0F9FF', color: '#0284C7' }}>
          ...
          <div className="flex gap-6 mb-5">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs text-neutral-500 font-medium">예상 기간</p>
                <p className="text-base font-bold text-neutral-900">{daysFloor}일</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between mt-4">
            <div className="flex items-center gap-2 text-neutral-400 text-xs">
              ...
              <span>등록일: {props.createdAt.slice(0, 10).replaceAll('-', '.')}</span>
            </div>
          </div>
        </div>

        {/* right content */}
        <div className="w-72 border-l-2 border-neutral-200 flex flex-col justify-between p-6" style={{ background: 'linear-gradient(to bottom, #FAFAFA, white)' }}>
          <button
          ...
          <div>
            ...
            <div className="bg-white rounded-xl p-4 border-2 border-neutral-200 shadow-sm">
              <div className="flex items-center gap-3">
                <img src={clientImg} alt="client" className="w-12 h-12 rounded-full ring-2 ring-neutral-200" />
