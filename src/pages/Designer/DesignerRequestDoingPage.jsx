...
export default function DesignerRequestDoingPage() {
  ...
  return (
    <div className="bg-white w-[95%] min-h-[710px] rounded-[11px] py-[20px] flex flex-col gap-[20px]">
      <div className="flex justify-between pl-[17px]">
        <button
        ...
        >
          ...
          />
          <span className="text-[#D8DAE5] text-[13px] font-light">
            내 작업 목록
          </span>
        </button>
        <div className="flex  gap-[15px] pr-[36px] items-start ">
          <div className="flex flex-col items-end">
            <h1 className="text-[#525466] text-[16px]">{useDoingData.title}</h1>
            <p className="text-[#525466] text-[13px] font-light">진행 중</p>
          </div>
          <div className="text-[15px]">{useDoingData.user} 님과의 프로젝트</div>
        </div>
      </div>
      <div className="px-[6%] gap-[20px] w-[100%] h-[600px] flex flex-col justify-between">
        ...
        <div className="overflow-y-auto h-[55%] pl-[8px] custom-scrollbar">
        ...
        <div className="w-[100%] h-[38px] flex justify-around">
          <button className="flex justify-center items-center w-[33%] rounded-[19px] bg-[#DFE1ED] text-[#23242B] text-[16px]">
            결과물 제출하기
          </button>
          <button className="flex justify-center items-center w-[33%] rounded-[19px] bg-[#DFE1ED] text-[#23242B] text-[16px]">
            피드백 확인
