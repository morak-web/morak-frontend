...
import MessageBubble from '../../request-list/IntermediateFeedback/MessageBubble';
...
export default function ChatingPage() {
  ...
  return (
    <div className="bg-[#F7F8FC] min-h-0 w-full h-full rounded-[15px] pl-[30px] pr-[10px] pt-[20px] pb-[10px] flex flex-col justify-between">
      <div className="pr-[18px] custom-scrollbar overflow-y-auto flex flex-1 flex-col mb-[10px] gap-[10px] min-h-0">
        {message.map((msg, i) => (
      ...
      <div className=" flex h-[51px] bg-[#EDEFF7] items-center rounded-[35px] px-2">
        <input
          type="text"
          value={input}
