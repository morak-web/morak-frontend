  ...
  return (
    <MainLayout>
      <div className="w-[100%] bg-[#f1f2f8] h-[calc(100vh-64px)]  py-[62px]">
        <div className="w-[55%] mx-auto bg-white h-[99%] rounded-[16px] shadow-[6px_0px_5px_rgba(0,0,0,0.1),0_7px_6px_rgba(0,0,0,0.1)] px-[42px] py-[29px]">
          <h1 className="text-[24px]">프로젝트 카테고리</h1>
          <div className="grid grid-cols-3 gap-13 h-[80%] mt-[30px]">
            {CATEGORY.map((item) => (
          ...
          <div className="flex justify-between mt-[27px]">
            <button className=" text-[18px] cursor-pointer">이전</button>
            <button className="bg-[#BDCFFF] px-[17px] py-[8px] rounded-[8px] text-[18px] cursor-pointer">
              다음
            </button>
          </div>
        </div>
