...
export default function RequestWritePage() {
  return (
    <MainLayout>
      <div className="w-[100%] bg-[#f1f2f8] min-h-[calc(100vh-64px)] py-[30px] sm:py-[62px] flex items-center">
        <div className=" w-[100%] sm:w-[55%] mx-auto bg-white h-[99%] rounded-[16px] shadow-[6px_0px_5px_rgba(0,0,0,0.1),0_7px_6px_rgba(0,0,0,0.1)] px-[42px] py-[29px] flex flex-col justify-between">
          ...
          <textarea
            className="w-[100%] h-[280px] bg-[#F7F8FC] rounded-[20px] resize-none py-[26px] px-[31px] text-black font-[16px] border-[1px] border-transparent outline-none focus:border-[1px] focus:border-[#d6d6d694] mb-[269px]"
