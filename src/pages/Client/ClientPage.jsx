      ...
      <div className="flex flex-col 2xl:pr-[20%] gap-[8px] ">
        {ASIDE_BAR.map((item) => (
          <Link
            key={item.title}
            to={item.link}
            className={` border-t-[2px] w-[80px] sm:w-[152px] h-[50px] text-[13px] sm:text-[15px] pt-[10px] font-bold text-left ${item.title === clickedBar ? 'text-[#474858] border-[rgba(195,196,206)] ' : 'text-[rgba(195,196,206)]'}`}
